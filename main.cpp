...
Vertex lightVertices[] = {Vertex{glm::vec3(-0.1f, -0.1f, 0.1f)},
...
int main() {
  ...
  Texture textures[]{Texture("./resources/textures/planks.png", "diffuse", 0,
                             GL_RGBA, GL_UNSIGNED_BYTE),
                     Texture("./resources/textures/planksSpec.png", "specular",
